...
import "@fontsource/alternate-gothic/400.css";
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-yellow-200 font-serif">
      ...
      <header className="bg-[#8B4513] text-white py-5 shadow-lg sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center px-6">
          <h1 className="text-3xl font-bold tracking-wide font-[AlternateGothic]">🌅 Sunnyside Country Store</h1>
          <nav>
            <ul className="flex space-x-6 text-lg">
              <li><a href="#home" className="hover:text-yellow-300 transition font-[AlternateGothic]">Home</a></li>
              <li><a href="#about" className="hover:text-yellow-300 transition font-[AlternateGothic]">About</a></li>
              <li><a href="#services" className="hover:text-yellow-300 transition font-[AlternateGothic]">Services</a></li>
              <li><a href="#contact" className="hover:text-yellow-300 transition font-[AlternateGothic]">Contact</a></li>
            </ul>
          </nav>
        </div>
      </header>
      ...
      <section id="home" className="relative h-[600px] flex items-center justify-center">
        ...
        <div className="text-center text-white z-10 bg-black bg-opacity-50 px-8 py-6 rounded-lg shadow-lg">
          <h2 className="text-6xl font-bold mb-4 font-[AlternateGothic]">🌻 Opening Soon! 🌾</h2>
          <p className="text-2xl font-[AlternateGothic]">Your Neighborhood Stop for Essentials & More</p>
        </div>
      </section>
      ...
      <section id="hours" className="py-16 bg-white text-center shadow-md rounded-lg mx-4 my-8">
        <div className="container mx-auto max-w-lg">
          <h2 className="text-4xl font-bold text-[#8B4513] mb-6 uppercase tracking-widest font-[AlternateGothic]">Store Hours</h2>
      ...
      <section id="signup" className="py-16 bg-[#FFF3CD] text-center shadow-md rounded-lg mx-4 my-8">
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-4xl font-bold text-[#8B4513] mb-6 uppercase tracking-widest font-[AlternateGothic]">Sign Up</h2>
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <button type="submit" className="bg-[#8B4513] hover:bg-[#654321] text-white px-6 py-3 rounded-full text-lg md:col-span-2 font-[AlternateGothic]">Send Message</button>
          </form>
        </div>
      </section>
      ...
      <footer className="bg-[#8B4513] text-white py-6 text-center mt-8">
        <p className="text-lg font-[AlternateGothic]">© 2025 Sunnyside Country Store. All rights reserved.</p>
      </footer>
    </div>
  );
}
