      ...
      <section id="contact" className="py-16 bg-[#FFEB99] shadow-md rounded-lg mx-4 my-8">
        <div className="container mx-auto flex flex-col md:flex-row justify-between">
          <div className="md:w-1/2 text-left px-6">
            ...
            <p className="text-lg">📅 Mon-Thu: 7:00 AM - 10:00 PM</p>
            <p className="text-lg">📅 Fri-Sat: 7:00 AM - MIDNIGHT</p>
            <p className="text-lg">📅 Sun: 11:00 AM - 9:00 PM</p>
            <h2 className="text-4xl font-bold text-[#8B4513] mt-8 mb-6">Contact</h2>
